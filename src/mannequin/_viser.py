...
PALETTES: dict[str, tuple[Color, Color]] = {
    "sand": ((196, 163, 112), (143, 107, 66)),
    "ivory": ((236, 231, 221), (139, 131, 120)),
    "charcoal": ((70, 72, 77), (176, 180, 187)),
    "sage": ((168, 181, 157), (98, 113, 90)),
    "clay": ((198, 124, 92), (117, 69, 49)),
    "slate": ((128, 146, 167), (69, 82, 99)),
}
